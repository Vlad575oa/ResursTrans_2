...
export const metadata = {
    ...
    description: "Витрина из 10 различных стилей для блоков выбора.",
};
                ...
                <div className="container mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-12">
                        ...
                        <nav className="hidden md:flex items-center gap-8">
                            ...
                            <Link className="text-sm font-bold text-emerald-500 border-b-2 border-emerald-500 pb-1" href="/showcase">Витрина</Link>
            ...
            <main className="container mx-auto px-6 py-20 max-w-7xl">
                <div className="max-w-3xl mb-20">
                    <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight mb-6">
                        Витрина Дизайн-Концепций
                    </h1>
                    <p className="text-lg text-slate-400 leading-relaxed">
                        Здесь представлены 10 уникальных стилистических направлений для интерактивных компонентов выбора транспорта. Оцените каждый из них, чтобы выбрать подходящий для рабочих страниц сайта.
                    </p>
                </div>
