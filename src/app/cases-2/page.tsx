...
export const metadata: Metadata = {
    title: "FleetTech - Intelligent Fleet Management Cases V2",
    description: "Real-world implementation results and efficiency gains with FleetTech system (Expanded Layout).",
};
...
export default function CasesPageV2() {
    return (
