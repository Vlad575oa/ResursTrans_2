...
const timelineData = [
    {
        ...
        description: "РесурсЛогистика начинает свой путь как амбициозный стартап в сфере транспортной логистики. Первые клиенты, первые маршруты, первые успехи.",
    ...
    },
    {
        ...
        description: "РесурсЛогистика — признанный эксперт и надежный партнер крупнейших корпораций России в сфере управления транспортом.",
