export default function ChallengesDark() {
    return (
                ...
                <div className="flex flex-col gap-8">
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-2 text-red-500">
                            ...
                            <span className="text-xs font-bold tracking-[0.15em] uppercase">Challenges</span>
                        </div>
                    ...
                    <div className="grid gap-6">
                        {[
                            { title: "Rising Costs", desc: "Unpredictable maintenance spikes and fuel inefficiency draining budgets.", icon: "trending_up" },
                            { title: "Opaque Control", desc: "Lack of real-time data creating blind spots in daily operations.", icon: "visibility_off" },
                            { title: "Staffing Complexities", desc: "High turnover rates and costly training cycles for new drivers.", icon: "group_off" },
                            { title: "Downtime Risks", desc: "Unexpected failures halting critical supply lines and revenue.", icon: "timer_off" },
                        ].map((item) => (
                ...
                <div className="relative">
                    <div className="bg-[#1a1d23]/70 backdrop-blur-xl rounded-2xl p-8 md:p-10 flex flex-col gap-8 relative overflow-hidden group border border-white/10 hover:border-primary/50 transition-colors duration-500">
                        ...
                        <div className="relative z-10 flex flex-col gap-6">
                            ...
                            <div>
                                <h3 className="text-white text-2xl md:text-3xl font-bold mb-3 tracking-tight">Full-Cycle Management</h3>
