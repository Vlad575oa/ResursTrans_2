export default function StatsBar() {
  return (
    <div className="relative z-10 w-full mt-auto border-t border-white/10 bg-[#0a0e1a]/90 backdrop-blur-xl">
      <div className="max-w-[1280px] mx-auto px-6 md:px-10 lg:px-20 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 divide-y md:divide-y-0 md:divide-x divide-white/10">
          ...
          <div className="flex items-center gap-5 md:pr-8 pt-4 md:pt-0">
            ...
            <div>
              <p className="text-3xl font-extrabold text-white tracking-tight">15+</p>
          ...
          <div className="flex items-center gap-5 md:px-8 pt-4 md:pt-0">
            ...
            <div>
              <p className="text-3xl font-extrabold text-white tracking-tight">1 000+</p>
              <p className="text-slate-400 text-sm font-medium uppercase tracking-wider">
                единиц транспорта
              </p>
            </div>
          ...
          <div className="flex items-center gap-5 md:pl-8 pt-4 md:pt-0">
            ...
            <div>
              <p className="text-3xl font-extrabold text-white tracking-tight">200+</p>
              <p className="text-slate-400 text-sm font-medium uppercase tracking-wider">
