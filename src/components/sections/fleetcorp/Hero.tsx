        ...
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            <h1 className="text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.1] tracking-tight">
              ...
              <br />
              автопарком{" "}
              <span className="text-primary text-glow">нового уровня</span>
            </h1>
            ...
            <div className="glass-panel p-6 rounded-xl max-w-2xl border-l-4 border-l-primary">
              <p className="text-slate-200 text-lg md:text-xl font-normal leading-relaxed">
                Полный аутсорсинг транспортной функции: контроль, эффективность,
                снижение затрат и прозрачность процессов.
              </p>
            </div>
          ...
          <div className="hidden lg:flex lg:col-span-5 justify-end relative">
            ...
            <div className="absolute top-1/2 left-0 -translate-y-1/2 glass-panel p-5 rounded-2xl w-72 shadow-2xl animate-[float_6s_ease-in-out_infinite]">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white text-sm font-bold">Оптимизация</p>
                  <p className="text-slate-400 text-xs">Текущий месяц</p>
                </div>
              </div>
            </div>
          </div>
